...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="❤️ sᴜᴘᴘᴏʀᴛ ❤️", url=f"https://t.me/{SUPPORT_CHAT}"
        ),
        InlineKeyboardButton(
